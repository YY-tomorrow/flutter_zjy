...
class JsonConvert<T> {
    ...
    switch (type) {			case NewsModel:
			...
			return newsDataDataFromJson(data as NewsDataData, json) as T;			case SpiderPlansModel:
			...
			return spiderPlansDataPlansElemantsFromJson(data as SpiderPlansDataPlansElemants, json) as T;    }
    return data as T;
  }  static _getToJson<T>(Type type, data) {
		switch (type) {			case NewsModel:
			return newsModelToJson(data as NewsModel);			case NewsData:
			return newsDataToJson(data as NewsData);			case NewsDataData:
			return newsDataDataToJson(data as NewsDataData);			case SpiderPlansModel:
			...
			return spiderPlansDataPlansElemantsToJson(data as SpiderPlansDataPlansElemants);    }
    return data as T;
    ...
    switch (T.toString()) {			case 'NewsModel':
			...
			return NewsDataData().fromJson(json) as T;			case 'SpiderPlansModel':
			...
			return SpiderPlansDataPlansElemants().fromJson(json) as T;    }
    return null;
  }}